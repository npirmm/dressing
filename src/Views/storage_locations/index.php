...
<div class="row mb-3">
    <div class="col-md-2"><input type="text" id="slRoomSearch" class="form-control" placeholder="Search Room..."></div>
    <div class="col-md-2"><input type="text" id="slAreaSearch" class="form-control" placeholder="Search Area..."></div>
    <div class="col-md-3"><input type="text" id="slShelfSearch" class="form-control" placeholder="Search Shelf/Rack..."></div>
    <div class="col-md-3"><input type="text" id="slLevelSearch" class="form-control" placeholder="Search Level/Section..."></div>
    <div class="col-md-2"><input type="text" id="slSpotSearch" class="form-control" placeholder="Search Spot/Box..."></div>
</div>

<?php if (empty($storageLocations)): ?>
    <div class="alert alert-info">No locations found.</div>
<?php else: ?>
    <table class="table table-striped table-hover" id="storageLocationsTable">
        <thead class="table-dark">
            <tr>
                ...
                <th><?php echo Helper::generateSortLink('full_location_path', 'Full Path', $currentSortColumn, $currentSortOrder, $baseUrl); ?></th>
                <th>Actions</th>
            </tr>
        </thead>
        <tbody>
            <?php foreach ($storageLocations as $item): ?>
                <tr>
                    ...
                    <td><?php echo Helper::e($item['full_location_path'] ?? 'N/A'); ?></td>
                    <td>
